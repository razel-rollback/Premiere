...
class SectionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $sections = [
            ...
            ['sectionName' => 'ABM-11-A', 'strandID' => 2, 'gradeLevelID' => 2, 'room' => '5', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['sectionName' => 'ABM-11-B', 'strandID' => 2, 'gradeLevelID' => 2, 'room' => '6', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['sectionName' => 'ABM-11-C', 'strandID' => 2, 'gradeLevelID' => 2, 'room' => '7', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],

            ['sectionName' => 'Stem-12-A', 'strandID' => 1, 'gradeLevelID' => 1, 'room' => '8', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['sectionName' => 'Stem-12-B', 'strandID' => 1, 'gradeLevelID' => 1, 'room' => '9', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['sectionName' => 'Stem-12-C', 'strandID' => 1, 'gradeLevelID' => 1, 'room' => '10', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['sectionName' => 'Stem-12-D', 'strandID' => 1, 'gradeLevelID' => 1, 'room' => '11', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
