...
<body class="register-body row">
                ...
                <form action="" method="POST" onsubmit="localStorage.clear();">
                    ...
                    <div class="row">
                        <div class="col text-end">
                            ...
                            <button type="submit" class="btn btn-primary" style="border-radius: 10px;">Done</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script>
        function updateSuffix(value) {
            ...
            suffixButton.textContent = value || 'Select';
        }
        ...
        function clearForm() {
            ...
            // Reset the suffix button
            document.getElementById('guardiansuffix').textContent = 'Select';
