...
<div class="container-fluid">
    <div class="page-header">
        <h1 class="page-title">Strands</h1>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover" id="linktable">
            ...
            <tbody>
                ...
                <tr>
                    <td><span class="badge-pill">{{ $strand->strandID }}</span></td>
                    <td>{{ $strand->strandName }}</td>
                    <td><span class="badge-type">{{ $strand->track->trackName }}</span></td>
                    <td class="text-center action-buttons">
                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editStrandModal{{ $strand->strandID }}">
