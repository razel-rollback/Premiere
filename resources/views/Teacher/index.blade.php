    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover" id="linktable">
            ...
            <tbody>
                ...
                <tr>
                    <td><span class="badge-pill">{{ $teacher->teacherID }}</span></td>
                    <td>{{ $teacher->teacherName }}</td>
                    <td>{{ $teacher->specialization }}</td>
                    <td class="text-center action-buttons">
                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#EditTeacherModal{{ $teacher->teacherID }}">
                            <i class="bi bi-pencil"></i> Edit
                        </button>
                        <form action="{{ route('teachers.destroy', $teacher->teacherID) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
