    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover" id="linktable">
            ...
            <tbody>
                ...
                <tr>
                    <td><span class="badge-pill">{{ $Track->trackID }}</span></td>
                    <td>{{ $Track->trackName }}</td>
                    <td class="text-center action-buttons">
                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#EditTrackModal{{ $Track->trackID }}">
